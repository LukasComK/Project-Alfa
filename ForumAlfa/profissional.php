    ...
    <header class="cabecalho" id="idCabecalho">
      <div class="container">
        <div class="cabecalho__cadastro">
          ...
          <p><a id="conta" href="alfa_profissional_alterar.php"><?php echo $_SESSION['NomeProfissional']; ?></a></p>
...
?>
  ...
  <ul class="responsive-table">
  <a class="tabela-link" href="view_topic_profissional.php?id= <?php echo $rows['id']?>">
    <li class="table-row">
...
<tr>
  <td><a class="criar-topico" href="criar_topic_profissional.php"><strong>Criar Novo Tópico</strong> </a></td>
</tr>
